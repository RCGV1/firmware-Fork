...
bool RoutingModule::handleReceivedProtobuf(const meshtastic_MeshPacket &mp, meshtastic_Routing *r)
{
    ...
    if (mp.which_payload_variant == meshtastic_MeshPacket_encrypted_tag &&
        ...
        // Don't let licensed users rebroadcast packets from unlicensed users.
        // We intentionally do NOT check mp.to here: dropping relay of a DM because the
        // final recipient is unlicensed would silently break delivery through licensed relay nodes.
