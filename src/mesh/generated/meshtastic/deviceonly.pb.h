...
typedef struct _meshtastic_DeviceState {
 ...
 Might be null */
    ...
    /* Last accepted MeshControl seq_num for replay protection.
 Persisted across reboots so old replayed packets are rejected after a reboot.
 Managed entirely by the firmware; do not set manually. */
    uint32_t last_accepted_mesh_control_seq_num;
...
#define meshtastic_DeviceState_last_accepted_mesh_control_seq_num_tag 14
...
X(a, STATIC,   SINGULAR, UINT32,   last_accepted_mesh_control_seq_num,  14)
